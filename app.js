...
const experiments = [
  ...
  { name: 'BICEP', description: 'Description', link: 'https://experiment2.com', position: [-390, -50], color: 'green' },
  { name: 'VLT', description: 'Description', link: 'https://experiment2.com', position: [-325, -330], color: 'green' },
  // { name: 'MUSE/VIMOS', description: 'Description', link: 'https://experiment2.com', position: [300, 300], color: 'green' },
  { name: 'POLARBEAR', description: 'Description', link: 'https://experiment2.com', position: [-245, -330], color: 'green' },
