...
const experiments = [
  ...
  { name: 'ALPS', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [320, -35], color: 'green' },
  { name: 'MADMAX', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [300, -110], color: 'green' },
  { name: 'BRASS', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [280, -125], color: 'red' },
  { name: 'LOFAR', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [258, -146], color: 'red' },
  { name: 'SUPAX', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [235, -168], color: 'red' },
  { name: 'CASPEr', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [213, -173], color: 'green' },
  { name: 'AION', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [190, -173], color: 'blue' },
  { name: 'DAMNED', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [168, -182], color: 'blue' },
  { name: 'SHUKET', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [148, -179], color: 'red' },
  { name: 'GrAHal', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [128, -179], color: 'green' },
  { name: 'DAMIC', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [109, -172], color: 'red' },
  ...
  { name: 'NASDUCK', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [20, 212], color: 'green' },
  { name: 'MuDHI', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [-70, 255], color: 'red' },
  { name: 'ARGO-YBJ', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [60, 325], color: 'green' },
  { name: 'PandaX', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [-15, 390], color: 'red' },
  ...
  { name: 'DOSUE-RR', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [15, 720], color: 'red' },
  { name: 'DANCE', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [45, 760], color: 'green' },
  { name: 'SUMICO', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [75, 760], color: 'green' },
  { name: 'SKA', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [-225, 490], color: 'green' },
  { name: 'UPLOAD/DOWNLOAD', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [-250, 300], color: 'green' },
  { name: 'ORGAN', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [-300, 435], color: 'green' },
  { name: 'PPTA', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [-295,780], color: 'blue' },
