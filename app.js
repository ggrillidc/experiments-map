...
const experiments = [
  { name: 'QUAX', description: 'Description for Experiment 1', link: 'https://experiment1.com', position: [0, -90], color: 'green'},
  { name: 'DarkSide', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [-10, 40], color: 'red' },
  { name: 'XENON', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [20, 60], color: 'red' },
  { name: 'nEDM', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [40, 100], color: 'green' },
  { name: 'OSQAR', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [60, 140], color: 'green' },
  { name: 'CROWS', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [80, 160], color: 'green' },
  { name: 'CAST', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [100, 180], color: 'green' },
  { name: 'BASE', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [120, 200], color: 'green' },
  { name: 'RADES', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [140, 75], color: 'green' },
  { name: 'FUNK', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [160, 80], color: 'red' },
  ...
  { name: 'WISPLC', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [300, 300], color: 'green' },
  { name: 'SHIPS', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [300, 300], color: 'red' },
  { name: 'IAXO', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [300, 300], color: 'green' },
  { name: 'ALPS', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [300, 300], color: 'green' },
  { name: 'MADMAX', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [300, 300], color: 'green' },
