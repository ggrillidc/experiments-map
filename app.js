...
const experiments = [
  ...
  { name: 'LOFAR', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [260, -155], color: 'red' },
  { name: 'SUPAX', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [240, -185], color: 'red' },
  { name: 'CASPEr', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [218, -205], color: 'green' },
  { name: 'AION', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [200, -205], color: 'blue' },
