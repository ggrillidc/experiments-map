...
const experiments = [
  ...
  { name: 'SUPAX', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [235, -162], color: 'red' },
  { name: 'CASPEr', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [213, -168], color: 'green' },
  { name: 'AION', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [190, -168], color: 'blue' },
  { name: 'DAMNED', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [168, -177], color: 'blue' },
  { name: 'SHUKET', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [150, -175], color: 'red' },
  { name: 'GrAHal', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [128, -175], color: 'green' },
  ...
  { name: 'AURIGA', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [40, -145], color: 'blue' },
