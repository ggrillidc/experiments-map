...
const experiments = [
  ...
  { name: 'SKA', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [-275, 490], color: 'green' },
  { name: 'UPLOAD/DOWNLOAD', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [-325, 325], color: 'green' },
  { name: 'ORGAN', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [-360, 450], color: 'green' },
  { name: 'PPTA', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [-350, 785], color: 'blue' },
