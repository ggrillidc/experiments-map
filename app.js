...
const experiments = [
  ...
  { name: 'OSQAR', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [60, 100], color: 'green' },
  { name: 'CROWS', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [90, 110], color: 'green' },
  { name: 'CAST', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [110, 130], color: 'green' },
  { name: 'BASE', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [140, 140], color: 'green' },
  { name: 'RADES', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [160, 140], color: 'green' },
  { name: 'FUNK', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [180, 140], color: 'red' },
  { name: 'JEDI', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [200, 130], color: 'green' },
