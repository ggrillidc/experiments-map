...
const experiments = [
  ...
  { name: 'BREAD', description: 'Description', link: 'https://experiment2.com', position: [168, -550], color: 'green' },
  { name: 'SQMS', description: 'Description', link: 'https://experiment2.com', position: [148, -575], color: 'red' },
  { name: 'DarkSRF', description: 'Description', link: 'https://experiment2.com', position: [128, -625], color: 'red' },
  { name: 'LZ', description: 'Description', link: 'https://experiment2.com', position: [108, -590], color: 'red' },
  { name: 'SNIPE', description: 'Description', link: 'https://experiment2.com', position: [65, -565], color: 'red' },
  { name: 'Eot-Wash', description: 'Description', link: 'https://experiment2.com', position: [200, -650], color: 'blue' },
  { name: 'ADMX', description: 'Description', link: 'https://experiment2.com', position: [187, -705], color: 'green' },
  { name: 'ORPHEUS', description: 'Description', link: 'https://experiment2.com', position: [168, -775], color: 'red' },
  { name: 'LIGO', description: 'Description', link: 'https://experiment2.com', position: [135, -750], color: 'blue' },
  { name: 'MAGIS', description: 'Description', link: 'https://experiment2.com', position: [109, -740], color: 'blue' },
  { name: 'DM-Radio', description: 'Description', link: 'https://experiment2.com', position: [85, -775], color: 'red' },
  { name: 'QUALIPHIDE', description: 'Description', link: 'https://experiment2.com', position: [45, -800], color: 'red' },
  { name: 'Dark E-field Radio', description: 'Description', link: 'https://experiment2.com', position: [15, -840], color: 'red' },
  { name: 'BACON', description: 'Description', link: 'https://experiment2.com', position: [-25, -675], color: 'blue' },
