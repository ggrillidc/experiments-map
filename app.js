...
const experiments = [
  ...
  { name: 'LIGO', description: 'Description', link: 'https://experiment2.com', position: [-40, -500], color: 'blue' },
  { name: 'ALPHA', description: 'Description', link: 'https://experiment2.com', position: [-15, -515], color: 'green' },
  { name: 'ADMX', description: 'Description', link: 'https://experiment2.com', position: [-15, -415], color: 'green' },
  { name: 'LAMPOST', description: 'Description', link: 'https://experiment2.com', position: [34, -420], color: 'red' },
