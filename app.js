...
const experiments = [
  ...
  { name: 'OSQAR', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [65, 100], color: 'green' },
  { name: 'CROWS', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [85, 110], color: 'green' },
  { name: 'CAST', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [115, 130], color: 'green' },
  { name: 'BASE', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [135, 140], color: 'green' },
  ...
  { name: 'GEO600', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [220, 95], color: 'blue' },
  { name: 'WISPDMX', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [240, 85], color: 'red' },
  { name: 'WISPLC', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [255, 70], color: 'green' },
  { name: 'SHIPS', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [275, -5], color: 'red' },
