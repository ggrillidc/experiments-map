...
const experiments = [
  ...
  { name: 'LAMPOST', description: 'Description', link: 'https://experiment2.com', position: [34, -425], color: 'red' },
  { name: 'ABRACADABRA', description: 'Description', link: 'https://experiment2.com', position: [55, -370], color: 'green' },
  { name: 'CASPEr', description: 'Description', link: 'https://experiment2.com', position: [75, -355], color: 'green' },
  { name: 'SHAFT', description: 'Description', link: 'https://experiment2.com', position: [95, -295], color: 'green' },
  { name: 'HAYSTAC', description: 'Description', link: 'https://experiment2.com', position: [115, -305], color: 'green' },
  { name: 'SNO', description: 'Description', link: 'https://experiment2.com', position: [135, -345], color: 'green' },
