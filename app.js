...
const experiments = [
  ...
  { name: 'LOFAR', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [258, -148], color: 'red' },
  { name: 'SUPAX', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [235, -155], color: 'red' },
  { name: 'CASPEr', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [213, -160], color: 'green' },
  { name: 'AION', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [190, -160], color: 'blue' },
  { name: 'DAMNED', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [168, -167], color: 'blue' },
  { name: 'SHUKET', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [150, -163], color: 'red' },
  { name: 'GrAHal', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [130, -163], color: 'green' },
  { name: 'DAMIC', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [110, -161], color: 'red' },
  { name: 'EDELWEISS', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [80, -175], color: 'red' },
  { name: 'CADEx', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [50, -70], color: 'green' },
