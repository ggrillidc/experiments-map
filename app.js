...
const experiments = [
  ...
  { name: 'ALPS', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [320, -25], color: 'green' },
  ...
  { name: 'SUPAX', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [235, -160], color: 'red' },
  { name: 'CASPEr', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [213, -165], color: 'green' },
  { name: 'AION', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [190, -165], color: 'blue' },
  { name: 'DAMNED', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [168, -172], color: 'blue' },
  { name: 'SHUKET', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [150, -163], color: 'red' },
  { name: 'GrAHal', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [128, -170], color: 'green' },
  { name: 'DAMIC', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [105, -165], color: 'red' },
  { name: 'EDELWEISS', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [85, -200], color: 'red' },
  { name: 'CADEx', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [68, -150], color: 'green' },
  { name: 'AURIGA', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [50, -145], color: 'blue' },
  { name: 'PVLAS', description: 'Description for Experiment 2', link: 'https://experiment2.com', position: [25, -70], color: 'green' },
