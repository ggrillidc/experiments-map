...
const experiments = [
  ...
  },
  {
    ...
    description: 'The DAMIC-M (DArk Matter In CCDs at Modane) experiment employs skipper charge-coupled devices (CCDs) to search for dark matter particles, leveraging their exceptional energy and spatial resolution. DAMIC-M CCDs, sensitive to signals as small as a few eV, are designed to capture the rare interactions of dark matter with the silicon nuclei or electrons. DAMIC- M will be installed at the underground laboratory of Modane and it will feature a kg - scale detector. Thanks to the ability of skipper CCDs to resolve single - electron signals, their small dark current(~300 e - /g/day), and the low radioactive background of the experiment(O(1) events / kg / day / keV), DAMIC - M will substantially advance the search for dark matter, with particular sensitivity to hidden - sector particles.',
    link: 'https://damicm.cnrs.fr/en/home/',//'https://damic.uchicago.edu',
    position: [85, -172],
    color: 'rgba(238,34,13,1)'
  },
  {
